...
class NewsTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.userFoto.image = UIImage(named: newsData[indexPath.row].foto)
        cell.userName.text = newsData[indexPath.row].name
        cell.newsData.text = newsData[indexPath.row].date
        cell.newsText.text = newsData[indexPath.row].newsText
        cell.newsFoto.image = UIImage(named: newsData[indexPath.row].newsFoto)
