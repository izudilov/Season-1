 ...
 /*   func prepare(for segue: UIStoryboardSegue, sender: Any?) {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if isFiltering {
            ...
            cell.groupLogo.image = try? UIImage(data: Data(contentsOf: (URL(string: filteredGroups[indexPath.row].photo_100) ?? URL(string: "https://vk.com/images/camera_100.png"))!))
            
        } else {
        
            cell.groupName.text =  self.groupsFromVK[indexPath.row].name
            cell.groupLogo.image = try? UIImage(data: Data(contentsOf: (URL(string: self.groupsFromVK[indexPath.row].photo_100) ?? URL(string: "https://vk.com/images/camera_100.png"))!))
        }
